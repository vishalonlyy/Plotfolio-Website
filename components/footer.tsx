...
marginTop={'5%'}
      // useColorModeValue('gray.50', 'gray.900')}
        bg={Theme.default.Theme.Main_Color_Footer}
        ...
        <Container as={Stack} maxW={'6xl'} py={10}>
          <SimpleGrid
            ...
            <Stack spacing={6}>
              <Box>
              <Heading color={'white'} size={'5px'}>Vishal</Heading>
              <Avatar src="/images/Vishal.jpg" size={'25px'} width={'50px'} />
               
              </Box>
              
              <Text fontSize={'sm'}>
                © 2022 Vishal Pvt Ltd All rights reserved
              </Text>
              <Stack direction={'row'} spacing={6}>
                <SocialButton label={'Discord'} href={'https://discord.gg/muzox'}>
                  <FaDiscord />
                </SocialButton>
            
              </Stack>
            </Stack>
            <Stack align={'flex-start'} color={Theme_.Theme.FootHeadings}>
              
            <ListHeader>Support</ListHeader>
              <Link href={'https://discord.gg/muzox'}>Support</Link>
            ...
            <Stack align={'flex-start'} color={Theme_.Theme.FootHeadings}>
              ...
              <Link href={'/ComponentsusedForWEB'}>componentsUsed</Link>
